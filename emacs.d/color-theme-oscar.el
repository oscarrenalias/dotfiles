...
(defun color-theme-oscar ()
  "My own color schema, slightly modified from the color-theme-gray30 by Girish Bharadwaj"
  (interactive)
  (color-theme-install
   '(color-theme-oscar
     ...
     (default ((t (:stipple nil :background "grey12" :foreground "gainsboro" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width normal :family "outline-courier new"))))
